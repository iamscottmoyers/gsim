...
module_item :
	 ...
	 // but parser gets it right: keyword chosen over IDENTIFIER.
        ...
        output_declaration |
        inout_declaration |
        ( net_type (expandrange)? ) => net_declaration |
        reg_declaration |
        time_declaration |
        integer_declaration |
        real_declaration |
...
init_val :
        ...
        '1\'bx' |
	n=NUMBER
	{ !strcmp($n.text->chars,"0") || !strcmp($n.text->chars,"1")}?
	;
...
edge_descriptor :
	'0x' | '1x'
      |
	n=NUMBER
	{ !strcmp($n.text->chars,"01") || !strcmp($n.text->chars,"10")}?
      |
	i=IDENTIFIER
	{ !strcmp($i.text->chars,"x1") || !strcmp($i.text->chars,"x0")}?
	;
...
expr10 :
        expr11 | LPAREN expression RPAREN
        ;

expr9 :
        expr10 | unary_operator expr9
        ;

expr8 :
        expr9 ( binary_operator expr9 )*
        ;

expr7 :
        expr8 ( QUESTION expr7 COLON expr7 )?
        ;
