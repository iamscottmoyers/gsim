...
main	(int argc, char *argv[])
{
    ...
    //
    vhdlParser_design_file_return vhdlAST;
    ...
    // the tree parser: c.f. vhdlWalker.g3t
    //
    pvhdlWalker		    treePsr;
	...
	{
		fName	=(pANTLR3_UINT8)"./input.vhd"; // Note in VS2005 debug, working directory must be configured
	}
	else
	{
    ...
    //
    lxr	    = vhdlLexerNew(input);	    // CLexerNew is generated by ANTLR
    ...
    //
    psr	    = vhdlParserNew(tstream);  // CParserNew is generated by ANTLR3
	...
	{
		printf("Tree : %s\n", vhdlAST.tree->toStringTree(vhdlAST.tree)->chars);
		nodes	= antlr3CommonTreeNodeStreamNewTree(vhdlAST.tree, ANTLR3_SIZE_HINT); // sIZE HINT WILL SOON BE DEPRECATED!!

		// Tree parsers are given a common tree node stream (or your override)
		//
		treePsr	= vhdlWalkerNew(nodes);

		treePsr->design_file(treePsr);
